  ...
  return (
    <>
      ...
      <div className="bg-gray-200">
        ...
        <div className="grid gap-4 lg:gap-8 md:grid-cols-3 p-8 pt-2">
          <div className="relative p-6 rounded-2xl bg-white shadow dark:bg-gray-800">
            <div className="space-y-2">
              <div className="flex items-center space-x-2 rtl:space-x-reverse text-sm font-medium text-gray-500 dark:text-gray-400">
              ...
              <div className="text-3xl dark:text-gray-100">192</div>
          ...
          <div className="relative p-6 rounded-2xl bg-white shadow dark:bg-gray-800">
            <div className="space-y-2">
              ...
              <div className="text-3xl dark:text-gray-100">$1343</div>
          ...
          <div className="relative p-6 rounded-2xl bg-white shadow dark:bg-gray-800">
            <div className="space-y-2">
              ...
              <div className="text-3xl dark:text-gray-100">$1400</div>
